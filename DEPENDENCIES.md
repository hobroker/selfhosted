...
> Auto-generated by `packages/catalog`. Run `npm run generate -- --dep-graph` to regenerate.
>
> To add a new dependency rule, edit `packages/catalog/src/dep-graph/rules.ts`.
